...
while True:
    ...
    if packet is None:
        ...
        pp(results)
        if results['type'] == 'wx':
            print(f"Temp: {results['t']} degrees")
            print(f"Relative humidity: {results['h']}%")
            print(f"Pressure: {results['p']} inHg")
            print(f"Dew Point: {results['dp']} degrees")
            print("RSSI: " + str(rfm69.last_rssi) + "\n\n")
        elif results['type'] == 'dist':
            print(f"Distance: {results['d']} in")
            print("RSSI: " + str(rfm69.last_rssi) + "\n\n")
